    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-sky-600 hover:bg-sky-700 text-white text-xs font-semibold rounded-xl shadow-sm shadow-sky-200 transition-all flex items-center gap-1.5 self-start sm:self-auto"
        >
              ...
              >
                <div>
                  ...
                  {item.component.tireCasing && (
                    <p className="text-xs text-sky-700 tabular-nums mt-1 font-medium">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-100 text-xs">
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200/80 rounded-xl flex items-center gap-1.5 transition-colors font-semibold shadow-xs"
                    ...
                    {hasMatchingStorage ? (
                      <button
                        ...
                        className="px-2.5 py-1.5 bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-200/80 rounded-xl flex items-center gap-1.5 transition-colors font-semibold cursor-pointer shadow-xs"
                        title={
                  ...
                  <Link
                    ...
                    className="text-slate-500 hover:text-sky-600 flex items-center gap-1 font-semibold transition-colors"
                  >
                    <span>Detail</span>
            ...
            <div className="grid grid-cols-2 gap-3 p-3 bg-slate-50/80 rounded-xl border border-slate-200/60 animate-fade-in">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200/80 rounded-xl px-3 py-1.5 text-slate-900 tabular-nums text-xs focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 shadow-sm"
                />
              </div>
              <div>
                <label className="block text-[11px] font-semibold text-slate-600 mb-1">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200/80 rounded-xl px-3 py-1.5 text-slate-900 text-xs focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 shadow-sm"
                />
              </div>
            </div>
          )}
          ...
          <div>
            ...
            {otherBikes.length === 0 ? (
              ...
              <select
                ...
                className="w-full bg-white border border-slate-200/80 rounded-xl px-3.5 py-2 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all shadow-sm"
              >
          ...
          <div>
            ...
            {storageComponents.length === 0 ? (
              <div className="p-4 bg-slate-50/80 rounded-xl border border-slate-200/60 text-xs text-slate-600 space-y-2">
                ...
                <Link
                  href="/components"
                  className="text-sky-600 hover:underline block font-semibold"
                >
